...
export function GeofenceField({
  ...
  return (
    <div className={`overflow-hidden rounded-card border shadow-[0_4px_24px_-12px_rgba(28,28,26,0.18)] ${dark ? "border-ink-700 bg-ink-900" : "border-line bg-paper"} ${disabled ? "opacity-70" : ""}`}>
      {/* Barra superior */}
