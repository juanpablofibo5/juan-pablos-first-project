...
| B-002 | P1 | Barrer huérfanos de `app/` + launch.json global | Sin `App.css`, `assets/` de template, `vitest.shims.d.ts`, `public/icons.svg`; launch.json global sin entrada storybook; build verde | AUDIT D3+D4 | hecho |
